...
// it is harmless. The Python backend does this same job; this Next.js route is a
// self-contained alternative when you deploy the UI alone.
//
...
export async function GET(request: Request) {
  ...
  // The response JSON puts the ephemeral key at data.value (see API_FACTS.md).
