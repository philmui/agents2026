...
BEFORE writing anything, READ these three files in full and obey them:
  1. ${ROOT}/docs/API_FACTS.md        (verified OpenAI Realtime API ground truth — the single source of truth)
  2. ${ROOT}/docs/COURSE_DESIGN.md    (the course blueprint, per-module deliverables, house style, mermaid + slide rules)
